...
export default function PaymentSuccess() {
    ...
    return (
        <main className="max-w-6xl mx-auto p-10 text-white text-center border m-10 rounded-md bg-gradient-to-tr from-blue-500 to-purple-500">
            <div className="mb-10">
                <div style={{ width: "5%", display: "flex", justifyContent: "center", margin: "0 auto", marginTop: "2rem" }}>

                    <Image src={checkmark} alt="Success" sizes="(max-width: 38px) 50vw, (max-width: 300px) 50vw, 33vw"
                    ></Image>
                </div>
                ...
                <div style={{ margin: "1rem" }}>Your Booking ID: {uniqueID}</div>

      ...
      <main>
        ...
        <div className={styles.appointmentPage}>
          ...
          <div className={styles.cartContainer}>
            <h2 className={styles.cartTitle}>Selected Services</h2>
          ...
          {exists ?
            // <div style={{ display: "flex", marginTop: "1rem", padding: "1rem", gap: ".5rem" }}>
            //   <div style={{ pointerEvents: "auto", color: "red", width: "auto" }} className={styles.nextBtn} onClick={() =>
            //     clearCart()}>Clear cart</div>

            // <div className={styles.bookBtn}>
            //   <Link href="/services/book" className={styles.nextBtn} style={{ pointerEvents: "auto", color: "rgb(198, 153, 134)", width: "auto" }}>
            //     Book Now
            //   </Link>
            // </div>
            ...
            <div className={styles.productCard}>
              <h3 className={styles.productName}>Cart</h3>
              <h3 className={styles.price}>$300.00</h3>
